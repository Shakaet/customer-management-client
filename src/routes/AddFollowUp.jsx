  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        {/* Lead Email */}
        <div>
          <label className="block font-medium mb-1">Lead Email <span className="text-red-500">*</span></label>
          <input
            type="email"
            name="email"
        ...
        {/* Follow-up Date */}
        <div>
          <label className="block font-medium mb-1">Follow-up Date <span className="text-red-500">*</span></label>
          <input
            type="date"
            name="followUpDate"
