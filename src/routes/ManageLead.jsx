          ...
          <tbody>
            {filteredLeads.map((lead, index) => (
              <tr key={lead._id} className="hover:bg-gray-50 transition">
                ...
                <td className="py-3 px-4 border">{lead.phone}</td>
                <td className="py-3 px-4 border">{lead.email}</td>
                <td className="py-3 px-4 border">{lead.product}</td>
                ...
                <td className="py-3 px-4 border text-red-600">
                  {lead.expectedDate}
                </td>
                <td className="py-3 px-4 border">{lead.notes}</td>
